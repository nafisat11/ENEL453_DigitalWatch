...
## Switches
set_property PACKAGE_PIN V17 [get_ports SW_START]
set_property IOSTANDARD LVCMOS33 [get_ports SW_START]
set_property PACKAGE_PIN V16 [get_ports LAP_TIME]
set_property IOSTANDARD LVCMOS33 [get_ports LAP_TIME]
set_property PACKAGE_PIN W16 [get_ports CD_START]
set_property IOSTANDARD LVCMOS33 [get_ports CD_START]
set_property PACKAGE_PIN W17 [get_ports LOAD]
set_property IOSTANDARD LVCMOS33 [get_ports LOAD]
set_property PACKAGE_PIN W15 [get_ports {time_digit[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {time_digit[3]}]
set_property PACKAGE_PIN V15 [get_ports {time_digit[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {time_digit[2]}]
set_property PACKAGE_PIN W14 [get_ports {time_digit[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {time_digit[1]}]
set_property PACKAGE_PIN W13 [get_ports {time_digit[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {time_digit[0]}]
